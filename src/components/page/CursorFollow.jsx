...
const CursorFollow = ({ sectionRef, hoverRef }) => {
  ...
  return (
    isVisible && ( // Só renderiza o cursor se estiver dentro da Section
      <motion.div
        className="bg-emerald-500 backdrop-blur-lg shadow-[0_0_10px_#34d399] w-8 h-8 rounded-full fixed top-0 left-0 pointer-events-none z-10"
        animate={{
